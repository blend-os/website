...
!!! question inline end "How can I check if I'm 64-bit?"
    ...
    **:material-apple: MacOS**: Click the :material-apple: and choose **About This Mac**. Anything other than *Intel Core Solo* or *Intel Core Duo* (Intel Core Duo **2** is 64-bit) under **CPU** is **64-bit**.
